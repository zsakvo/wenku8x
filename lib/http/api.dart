...
class API {
  ...
  static addBookToShelf(dynamic aid) async {
    return await Ajax.post("action=bookcase&do=add&aid=$aid", isXml: false);
  }

  static delBookFromShelf(dynamic aid) async {
    return await Ajax.post("action=bookcase&do=del&aid=$aid", isXml: false);
  }
}
