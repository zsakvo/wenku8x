...
class EpubCfiParser {
   ...
   */
  static String quote(String s) => '"${s.replaceAll(RegExp(r'\\'), '\\\\') // backslash
  ...
  CfiFragment? _parseFragment() {
    ...
    pos0 = pos;
    pos1 = pos;
    if ((pos + 8) < input.length && input.substring(pos, pos + 8) == 'epubcfi(') {
      result0 = 'epubcfi(';
      pos += 8;
    } else {
      result0 = null;
  ...
  CfiRange? _parseRange() {
    ...
    if (result0 != null) {
      result0 = ((int offset, CfiStep? stepVal, CfiLocalPath? localPathVal, CfiLocalPath? rangeLocalPath1Val,
  ...
  CfiPath? _parsePath() {
    ...
    if (result0 != null) {
      result0 = ((int offset, CfiStep? stepVal, CfiLocalPath? localPathVal) => CfiPath(
            type: 'path',
            path: stepVal,
            localPath: localPathVal,
  ...
  CfiLocalPath _parseLocalPath() {
    ...
    if (result0 != null) {
      ...
      result2 = result2 ?? CfiTerminus(type: 'textTerminus', offsetValue: null, textAssertion: null);
    ...
    if (result0 != null) {
      result0 = ((int offset, List<CfiStep>? localPathStepVal, termStepVal) =>
          CfiLocalPath(steps: localPathStepVal, termStep: termStepVal))(pos0, result0[0], result0[1]);
    }
    if (result0 == null) {
      pos = pos0;
    }
  ...
  CfiTerminus? _parseTerminus() {
    ...
    if (result0 != null) {
      result0 = ((int offset, String textOffsetValue, textLocAssertVal) => CfiTerminus(
            type: 'textTerminus',
            offsetValue: int.parse(textOffsetValue),
            textAssertion: (textLocAssertVal ?? []).isNotEmpty ? textLocAssertVal[1] : null,
          ))(pos0, result0[1], result0[2]);
    }
    if (result0 == null) {
      pos = pos0;
  ...
  CfiTextLocationAssertion _parseTextLocationAssertion() {
    ...
    result0 = _parseCsv();
    result0 = result0 ?? CfiCsv(type: 'csv', preAssertion: null, postAssertion: null);
    if (result0 != null) {
      result1 = _parseParameter();
      result1 = result1 ?? CfiParameter(type: 'parameter', lHSValue: null, rHSValue: null);
      if (result1 != null) {
        result0 = [result0, result1];
      } else {
        result0 = null;
    ...
    if (result0 != null) {
      result0 = ((int offset, CfiCsv? csvVal, CfiParameter? paramVal) => CfiTextLocationAssertion(
  ...
  Map<String, dynamic>? _parseNumber() {
    ...
    if (result0 != null) {
      result0 = ((offset, intPartVal, fracPartVal) =>
          intPartVal.join('') + '.' + fracPartVal.join(''))(pos0, result0[0], result0[2]);
    }
    if (result0 == null) {
      pos = pos0;
    }
...
class CfiSyntaxException extends Equatable implements Exception {
  ...
  String _buildMessage() {
    ...
    foundHumanized = (found ?? '').isNotEmpty ? EpubCfiParser.quote(found!) : 'end of input';
