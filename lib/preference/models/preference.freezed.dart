...
/// Adds pattern-matching-related methods to [PreferenceModel].
extension PreferenceModelPatterns on PreferenceModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PreferenceModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PreferenceModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PreferenceModel value)  $default,){
final _that = this;
switch (_that) {
case _PreferenceModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PreferenceModel value)?  $default,){
final _that = this;
switch (_that) {
case _PreferenceModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode brightness,  StyleMode styleMode,  AppLanguage language,  bool autoSignIn)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PreferenceModel() when $default != null:
return $default(_that.brightness,_that.styleMode,_that.language,_that.autoSignIn);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode brightness,  StyleMode styleMode,  AppLanguage language,  bool autoSignIn)  $default,) {final _that = this;
switch (_that) {
case _PreferenceModel():
return $default(_that.brightness,_that.styleMode,_that.language,_that.autoSignIn);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode brightness,  StyleMode styleMode,  AppLanguage language,  bool autoSignIn)?  $default,) {final _that = this;
switch (_that) {
case _PreferenceModel() when $default != null:
return $default(_that.brightness,_that.styleMode,_that.language,_that.autoSignIn);case _:
  return null;
