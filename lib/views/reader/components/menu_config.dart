                    ...
                    children: [
                      Column(
                        children: [
                          CircleAvatar(
                            radius: 24,
                            backgroundColor: widget.horizontal ? widget.secondColor : widget.tertiaryColor,
                            child: IconButton(
                              onPressed: () {},
                              iconSize: 24,
                              icon: const Icon(
                      ...
                      Column(
                        children: [
                          CircleAvatar(
                            radius: 24,
                            backgroundColor: widget.volumeKey ? widget.secondColor : widget.tertiaryColor,
                            child: IconButton(
                              onPressed: () {},
                              iconSize: 24,
                              icon: const Icon(
                      ...
                      Column(
                        children: [
                          CircleAvatar(
                            radius: 24,
                            backgroundColor: widget.fullNext ? widget.secondColor : widget.tertiaryColor,
                            child: IconButton(
                              onPressed: () {},
                              iconSize: 24,
                              icon: const Icon(
                      ...
                      Column(
                        children: [
                          CircleAvatar(
                            radius: 24,
                            backgroundColor: widget.hideExtra ? widget.secondColor : widget.tertiaryColor,
                            child: IconButton(
                              onPressed: () {},
                              iconSize: 24,
                              icon: const Icon(
